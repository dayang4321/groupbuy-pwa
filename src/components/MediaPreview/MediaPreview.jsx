...
function MediaPreview(props) {
    const { photos, video, profilePhoto, removeHandler, productPhotoProgress, productVideoProgress,picturesLabel  } = props;
  ...
  return (
      <div className="mb-4">
        ...
        <>
          ...
          <div className="image-preview">
                      {profilePhoto.map(function (data, index) {
             //    console.log(this.indexOf(data))
                        return (<div key={index}> <img src={data} alt="upload preview" onClick={(e) => removeHandler('profile', index)} />
      ...
      {!!(photos && photos[0])  && (
        <>
          <h6 className="mb-2">{picturesLabel || 'Pictures'}</h6>
          <div className="image-preview">
